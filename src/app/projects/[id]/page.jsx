...
const ProjectDetails = ({ params }) => {
  ...
  return (
    <div style={{ backgroundColor: 'rgb(248, 237, 227)' }} className="min-h-screen">
      <div className="relative w-full h-[70vh] md:h-[80vh] lg:h-[90vh]">
        ...
        {/* Enhanced Overlay */}
        <div className="absolute bg-gradient-to-b from-black/40 via-black/30 to-black/60 inset-0">
          <div className="max-w-7xl mx-auto h-full">
            <div className="absolute bottom-9 flex flex-col lg:flex-row justify-between items-start lg:items-end px-4 md:px-10 w-full gap-4 lg:gap-8">
      ...
      <div className="mt-20 lg:mt-40 px-4 lg:px-5 grid gap-8 lg:gap-5 grid-cols-1 lg:grid-cols-2 max-w-7xl mx-auto">
        {/* Enhanced image */}
        <div>
          <img
        ...
        <div className="bg-white p-6 lg:p-8 rounded-2xl shadow-xl border border-gray-100">
          <div className="mb-6">
            <div className="inline-block px-4 py-2 rounded-full text-xs font-semibold uppercase tracking-wider mb-4" 
                 style={{ backgroundColor: 'rgba(141, 73, 58, 0.1)', color: 'rgb(141, 73, 58)' }}>
              Project Overview
            </div>
          ...
          <div className="space-y-10">
            <div>
              <h3 className="mt-5 text-2xl lg:text-3xl font-bold mb-4" style={{ color: 'rgb(141, 73, 58)' }}>
                {features?.title}
              </h3>
